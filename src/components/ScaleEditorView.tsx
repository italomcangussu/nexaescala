...
const ScaleEditorView: React.FC<ScaleEditorViewProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-70 flex flex-col h-full bg-slate-100 dark:bg-black overflow-y-auto pb-safe transition-all animate-in fade-in slide-in-from-bottom-4 duration-500">
            {isLoading && (
