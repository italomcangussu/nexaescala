...
const EditorMemberSidebar: React.FC<EditorMemberSidebarProps> = ({ members, onDragStart }) => {
    ...
    return (
        <div className="w-80 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col h-full shrink-0 z-20 shadow-xl">
            {/* Header */}
            <div className="p-4 border-b border-slate-100 dark:border-slate-800">
                <h3 className="font-bold text-slate-800 dark:text-slate-100 mb-1">Membros</h3>
                <p className="text-xs text-slate-500">Arraste para escalar</p>
            ...
            <div className="flex-1 overflow-y-auto p-2 space-y-2">
                {filteredMembers.map(member => (
                    <div
                        ...
                        className="group flex items-center gap-3 p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 border border-transparent hover:border-slate-200 dark:hover:border-slate-700 cursor-grab active:cursor-grabbing transition-all"
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            <h4 className="text-sm font-bold text-slate-700 dark:text-slate-200 truncate">{member.profile.full_name}</h4>
